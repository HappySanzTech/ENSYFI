...
#import "TeacherEventViewController.h"

@interface TeacherEventViewController ()
{
    AppDelegate *appDel;
    ...
    NSMutableArray *sub_event_status;
}
@end

@implementation TeacherEventViewController
...
- (void)viewDidLoad {
    ...
    sub_event_status = [[NSMutableArray alloc]init];
    ...
    [manager POST:api parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject)
     {
         ...
         sub_event_status = [arr_Events valueForKey:@"sub_event_status"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *sub_events = [sub_event_status objectAtIndex:indexPath.row];
    ...
    [[NSUserDefaults standardUserDefaults]setObject:sub_events forKey:@"sub_events_Key"];
